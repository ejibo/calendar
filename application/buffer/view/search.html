                                ...
                                <div class="table-stats">
                                    <table id="bootstrap-data-table" class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            include("active.php");
                                            $sql = "select a.id,b.name as name,c.name as position,d.name as time,e.name as place,f.name as item from schedule_info a left join user_info b on a.user_id = b.id left join user_position c on b.position_id = c.id left join schedule_time d on a.time_id = d.id left join schedule_place e on a.place_id = e.id left join schedule_item f on a.item_id = f.id";
                                            ...
                                            $table .= '<tr><td class="serial">3.</td><td>  <span class="product">cxg</span> </td><td>  <span class="product">院领导</span> </td><td>  <span class="product">2019年3月15日 周五下午</span> </td><td>  <span class="product">校本部</span> </td><td> <span class="product">开会</span> </td></tr>';
                                            echo($table);
                                            ?>                                                                            
                                        </tbody>                                   
                                    </table>
